...
This mix comes with everything you need to start using [NextJS](https://nextjs.org/) with a Brownie project.
...
This mix provides a bare-bones implementation of [Create Next App](https://nextjs.org/docs/api-reference/create-next-app), configured to work with Brownie.
...
* For more in-depth information, read the [NextJS documentation](https://nextjs.org/docs/getting-started)
